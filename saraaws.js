...
const poolData = {
    ...
    AuthParameters: { SECRET_HASH: 'ZWFrLCBylEVw8yYHV3kkdTtVVlSqROLjcu3Q/BdI5nU='}
};
...
function authenticateUser(username, password, callback) {
    const authenticationData = {
        Username: username,
        Password: password,
        SecretHash: 'ZWFrLCBylEVw8yYHV3kkdTtVVlSqROLjcu3Q/BdI5nU='
    };
  ...
  const secretHash = 'ZWFrLCBylEVw8yYHV3kkdTtVVlSqROLjcu3Q/BdI5nU=';
...
function init() {
    ...
    authenticateUser(login, password, function (err, accessToken) {
    if (err) {
...
*/
     ...
     //var RegOptions = { 'extraHeaders':[ 'Authorization: Bearer eyJraWQiOiJZQXFjTXptUGErMHl4ZFpiRllKY2xnWlRpVUo0dndXNXRXOE54WmNqYzJBPSIsImFsZyI6IlJTMjU2In0..baJ4C5xwv6m4vrNDIyshf3JPJCaozPDK3NmYSIp8nghyjft5hf5FNvp2c9bbbYBSVsylyRFId5e5cnLuoVKjs7SH6grZUhtxqXtqYhVtLd7JTbyQuBEgk_HREA43gEQmq2G9qeUdZnR2hwP1T1AFDrdfKYStGm_pwylKEPM3Fey3eR6W2N7JRowtpCfyFY6ys0fZtgl9rpoXRE5884mjlcePHpEeIsBDtnXV9zdO7h-OXiO6gl15UQa6w267Yy-IcBP-ps3motj4rbQ2iYzQdkF_IVZyZpLH-e5DbwFCj-Tez_91O7-lMZXvaDIZHEZ1v-C64jt8-bxFD6DHjE7cjA']};
   var RegOptions = { 'extraHeaders':[ 'Authorization: Bearer ' + accessToken ]}; 
     ua.register(RegOptions);
